...
@EntityListeners(AuditingEntityListener.class) // é usada em classes de entidades do JPA para
// habilitar o auditing (auditoria) automático, funciona em conjunto com o Spring Data JPA e
// o módulo de auditoria do Spring (@EnableJpaAuditing)
public class Autor {
